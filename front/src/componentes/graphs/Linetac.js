...
export const LineGraph = () => {
    ...
    acts.forEach(act => {
        ...
        console.log('Mes:', month, 'Valor esperado:', monthlyCounts[month]);
        if (month >= 0 && month < 12) {
            monthlyCounts[month]++;
        }
    });
    ...
    console.log('total mes:', monthlyCounts);
    console.log('Total mes', monthlyCountsc)
    ...
    if (actsError || conditionsError) return <p>Error: {actsError || conditionsError}</p>;
